...
@Component({
  selector: 'home-pooja-service',
  templateUrl: './home-pooja-service.component.html'
})
export class HomePoojaServiceComponent implements OnInit {
pujaServicesItems:any;
  constructor() { }

  ngOnInit() {
    this.pujaServicesItems =  [
      {
